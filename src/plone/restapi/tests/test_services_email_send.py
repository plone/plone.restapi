...
class EmailSendEndpoint(unittest.TestCase):
    ...
    def test_email_send_plain_text_has_intro(self):
        ...
        self.assertGreater(message_pos, intro_pos, "Intro text should appear before message")
    ...
    def test_email_send_multipart_no_intro(self):
        ...
        html_part = MIMEText("<html><body>This is the <b>HTML</b> version.</body></html>", "html")
    ...
    def test_email_send_multipart_structure_preserved(self):
        ...
        html_part = MIMEText("<html><body><p>HTML content here.</p></body></html>", "html")
